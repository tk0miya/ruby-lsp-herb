  ...
  module Herb
    ...
    class ErbAnalyzer
      ...
      def analyze #: void
        ...
        return if herb_parse_result.errors.any? # steep:ignore

        # Herb Lint: ERB tag formatting rules
        visitor = MyVisitor.new
        herb_parse_result.visit(visitor) # steep:ignore
      ...
      def to_prism_parse_result #: Prism::ParseResult # rubocop:disable Metrics/AbcSize
        ...
        prism_source = build_prism_source(herb_parse_result.source) # steep:ignore

        # Herb parser errors
        errors = herb_parse_result.errors.map do |error| # steep:ignore
        ...
        warnings = herb_parse_result.warnings.map do |warning| # steep:ignore
        ...
        value = herb_parse_result.value #: untyped # steep:ignore
